...
function App() {
  ...
  return (
   ...
   <div className="flex flex-wrap justify-center gap-3 shadow-lg bg-white px-3 py-2 rounded-xl">
            ...
            <button onClick={()=> setColor()}  type="button" className="outline-none px-4 bg-pink">Pink</button>
            <button onClick={()=> setColor()} type="button" className="outline-none px-4 bg-black">Black</button>
